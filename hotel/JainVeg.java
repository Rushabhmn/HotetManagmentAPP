...
public  class JainVeg implements Hotel
{
	double total;
	String f1="Jain Chilly       ";
	double p1=120.0;
	int q1;
	String f2="Jain Lollypop     ";
	double p2=150.0;
	int q2; 
	String f3="Jain  Spring Roll  ";
	double p3=180.0;
	int q3;
	
	String f4="Jain Masala       ";
	double p4=220.0;
	int q4;
	String f5="Butter Bread       ";
	double p5=280.0;
	int q5;
	String f6="Butter tost       ";
	double p6=290.0;
	int q6;
	...
	String f10="Jain Special Biryani      ";
	double p10=200.0;
	int q10;
